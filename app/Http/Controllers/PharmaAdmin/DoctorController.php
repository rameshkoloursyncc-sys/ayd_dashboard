...
class DoctorController extends Controller
{
    ...
    public function show($api_id)
    {
        ...
        // Fetch wallet summary and payout history from external API
        $walletSummary = null;
        $payoutHistory = [];
        try {
            ...
            Log::warning('Failed to fetch wallet/payout info for pharma-admin show: ' . $e->getMessage());
        }

        return view('doctors.show', compact('doctor', 'planDetails', 'walletSummary', 'payoutHistory'));
    }
