                ...
                <tbody>
                    @forelse($medicalExecutives as $executive)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $executive->name }}</td>
                            <td class="px-6 py-4">{{ $executive->email }}</td>
                            <td class="px-6 py-4">{{ $executive->pharma_company_name }}</td>
                            <td class="p-4 whitespace-nowrap">
                                @if($executive->is_local)
                                    <button type="button" 
                                ...
                                @else
                                    <span class="text-xs font-semibold inline-block py-1 px-2 rounded text-amber-600 bg-amber-200 last:mr-0 mr-1">
                                        External (Not Linked)
                                    </span>
                                @endif
                            </td>
