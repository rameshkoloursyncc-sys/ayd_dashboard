        ...
        <form action="{{ route($updateRoute, $doctor->api_id) }}" method="POST">
            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4 mt-4">Bank Account Details</h3>
                    <button type="button" data-modal-target="add-bank-account-modal" data-modal-toggle="add-bank-account-modal" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
