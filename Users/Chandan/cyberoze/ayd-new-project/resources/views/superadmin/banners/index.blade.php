...
<div class="px-4 pt-6">
    ...
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Manage Banners</h1>
        <a href="{{ route('superadmin.banners.create') }}" class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Add new banner</a>
    </div>
                        ...
                        @forelse ($banners as $banner)
                            <tr>
                                ...
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                    <img src="{{ $banner['image'] ?? '' }}" alt="Image" class="w-16 h-16 object-cover">
                                </td>
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                    {{ $banner['link'] ?? 'N/A' }}
                                </td>
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    <a href="{{ route('superadmin.banners.edit', $banner['_id']) }}" class="inline-flex items-center p-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    ...
                                    <form action="{{ route('superadmin.banners.destroy', $banner['_id']) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this banner?');" class="inline-flex">
                                        @csrf
                                        @method('DELETE')
