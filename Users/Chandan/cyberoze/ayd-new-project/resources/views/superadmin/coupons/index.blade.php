...
<div class="px-4 pt-6">
    ...
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Manage Coupons</h1>
        <a href="{{ route('superadmin.coupons.create') }}" class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Add new coupon</a>
    </div>
                        ...
                        @forelse ($coupons as $coupon)
                            <tr>
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    <a href="{{ route('superadmin.coupons.edit', $coupon['_id']) }}" class="inline-flex items-center p-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    ...
                                    <form action="{{ route('superadmin.coupons.destroy', $coupon['_id']) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this coupon?');" class="inline-flex">
                                        @csrf
                                        @method('DELETE')
